...
export default function CarouselClient() {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto text-primary">
      <h1 className="text-4xl md:text-5xl text-center mb-5 tracking-wider">
      ...
      >
        {data.map((item, idx) => (
          <SwiperSlide key={idx}>
            <div className="bg-gray-100 rounded-lg h-full flex flex-col justify-between mx-3">
              <div className="p-5">
                <Image
                  src={'/quote.png'}
                  alt={`Quote`}
                  ...
                  className="mb-4"
                />
                <p className="text-md md:text-lg tracking-wide mb-4">{item.message}</p>
              </div>
